"""Stage2A validation labels and reference continuity checks."""
...
def validate_stage2a(result: SimulationResult, cfg: SimConfig) -> dict:
...
__all__ = ["reference_continuity_check", "validate_stage2a"]
